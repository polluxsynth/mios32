...
// $Id: MbSidTables.cpp 850 2010-01-24 22:31:41Z tk $
/*
...
// (overrules entries 245-255 of normal LFO table if SID_I_LFO_MODE_CLKSYNC flag is set)
const u16 mbSidLfoTableMclk[11] = {
  16,	// 245: 64/1
  32,	// 246: 32/1
  64,	// 247: 16/1
  128,	// 248: 8/1
...
/////////////////////////////////////////////////////////////////////////////
// Drum Model Wavetables
/////////////////////////////////////////////////////////////////////////////

static const u8 sid_drum_model_WT_BD1[] = {
...
static const u8 sid_drum_model_WT_BD2[] = {
...
static const u8 sid_drum_model_WT_BD3[] = {
...
static const u8 sid_drum_model_WT_SD1[] = {
...
static const u8 sid_drum_model_WT_SD2[] = {
...
static const u8 sid_drum_model_WT_SD3[] = {
  0x4b | 0x00, 0x08, // Note/Wave Step #0
  0x3c | 0x80, 0x01, // Note/Wave Step #1
  0, 0 // End of WT
};

static const u8 sid_drum_model_WT_HH1[] = {
  0x6c | 0x80, 0x08, // Note/Wave Step #0
  0, 0 // End of WT
};

static const u8 sid_drum_model_WT_HH2[] = {
  0x6c | 0x80, 0x08, // Note/Wave Step #0
...
static const u8 sid_drum_model_WT_TO1[] = {
...
static const u8 sid_drum_model_WT_TO2[] = {
  0x3c | 0x80, 0x04, // Note/Wave Step #0
...
static const u8 sid_drum_model_WT_CLP[] = {
...
static const u8 sid_drum_model_WT_FX1[] = {
  0x3c | 0x80, 0x01, // Note/Wave Step #0
  0, 0 // End of WT
};

static const u8 sid_drum_model_WT_FX2[] = {
  0x3c | 0x80, 0x01, // Note/Wave Step #0
...
static const u8 sid_drum_model_WT_FX3[] = {
  0x3c | 0x80, 0x41, // Note/Wave Step #0
  0, 0 // End of WT
};

static const u8 sid_drum_model_WT_FX4[] = {
  0x3c | 0x80, 0x41, // Note/Wave Step #0
...
static const u8 sid_drum_model_WT_FX5[] = {
...
static const u8 sid_drum_model_WT_FX6[] = {
...
static const u8 sid_drum_model_WT_FX7[] = {
...
static const u8 sid_drum_model_WT_FX8[] = {
...
static const u8 sid_drum_model_WT_FX9[] = {
...
const sid_drum_model_t mbSidDrumModel[SID_SE_DRUM_MODEL_NUM] = {
  // name    type          note  GLng  Wave   PW  Speed  Loop  Wavetable
  { "BD1 ", SID_DRUM_MODEL_WT, 0x3c, 0x20, 0x01, 0x80, 0x0a, 0xff, (u8 *)&sid_drum_model_WT_BD1 },
  { "BD2 ", SID_DRUM_MODEL_WT, 0x6b, 0x20, 0x08, 0x80, 0x0a, 0xff, (u8 *)&sid_drum_model_WT_BD2 },
  { "BD3 ", SID_DRUM_MODEL_WT, 0x48, 0x20, 0x01, 0x80, 0x0a, 0xff, (u8 *)&sid_drum_model_WT_BD3 },
  { "SD1 ", SID_DRUM_MODEL_WT, 0x6b, 0x20, 0x08, 0x80, 0x0a, 0xff, (u8 *)&sid_drum_model_WT_SD1 },
  { "SD2 ", SID_DRUM_MODEL_WT, 0x50, 0x20, 0x08, 0x80, 0x0a, 0xff, (u8 *)&sid_drum_model_WT_SD2 },
  { "SD3 ", SID_DRUM_MODEL_WT, 0x4b, 0x20, 0x08, 0x80, 0x0a, 0x00, (u8 *)&sid_drum_model_WT_SD3 },
  { "HH1 ", SID_DRUM_MODEL_WT, 0x6c, 0x20, 0x08, 0x80, 0x0a, 0xff, (u8 *)&sid_drum_model_WT_HH1 },
  { "HH2 ", SID_DRUM_MODEL_WT, 0x6c, 0x20, 0x08, 0x80, 0x0a, 0xff, (u8 *)&sid_drum_model_WT_HH2 },
  { "TO1 ", SID_DRUM_MODEL_WT, 0x3c, 0x20, 0x04, 0x80, 0x0a, 0xff, (u8 *)&sid_drum_model_WT_TO1 },
  { "TO2 ", SID_DRUM_MODEL_WT, 0x3c, 0x20, 0x04, 0x80, 0x0a, 0x0c, (u8 *)&sid_drum_model_WT_TO2 },
  { "CLP ", SID_DRUM_MODEL_WT, 0x3c, 0x20, 0x08, 0x80, 0x0a, 0x01, (u8 *)&sid_drum_model_WT_CLP },
  { "FX1 ", SID_DRUM_MODEL_WT, 0x3c, 0x20, 0x01, 0x80, 0x0a, 0xff, (u8 *)&sid_drum_model_WT_FX1 },
  { "FX2 ", SID_DRUM_MODEL_WT, 0x3c, 0x20, 0x01, 0x80, 0x0a, 0x00, (u8 *)&sid_drum_model_WT_FX2 },
  { "FX3 ", SID_DRUM_MODEL_WT, 0x3c, 0x20, 0x41, 0x80, 0x0a, 0xff, (u8 *)&sid_drum_model_WT_FX3 },
  { "FX4 ", SID_DRUM_MODEL_WT, 0x3c, 0x20, 0x41, 0x80, 0x0a, 0xff, (u8 *)&sid_drum_model_WT_FX4 },
  { "FX5 ", SID_DRUM_MODEL_WT, 0x54, 0x20, 0x04, 0x80, 0x0a, 0x0a, (u8 *)&sid_drum_model_WT_FX5 },
  { "FX6 ", SID_DRUM_MODEL_WT, 0x18, 0x20, 0x01, 0x80, 0x0a, 0x00, (u8 *)&sid_drum_model_WT_FX6 },
  { "FX7 ", SID_DRUM_MODEL_WT, 0x18, 0x20, 0x02, 0x80, 0x0a, 0x00, (u8 *)&sid_drum_model_WT_FX7 },
  { "FX8 ", SID_DRUM_MODEL_WT, 0x70, 0x20, 0x08, 0x80, 0x0a, 0x00, (u8 *)&sid_drum_model_WT_FX8 },
  { "FX9 ", SID_DRUM_MODEL_WT, 0x18, 0x20, 0x04, 0x80, 0x0a, 0x00, (u8 *)&sid_drum_model_WT_FX9 },
};
...
const u8 mbSidPatchPresetLead[512] = {
 'L','e','a','d',' ','P','a','t','c','h',' ',' ',' ',' ',' ',' ',
...
//Flgs  Wave   AD    SR   PW_L  PW_H  Res1  Delay Trns  Fine  PRng  Port. ArpM  A.S/D A.G/R Res2
  0x00, 0x04, 0x00, 0xf0, 0x00, 0x08, 0x00, 0x00, 0x40, 0x80, 0x02, 0x00, 0x00, 0x5f, 0x05, 0x00,	// SID1 Voice1
  0x00, 0x14, 0x00, 0xf0, 0x00, 0x08, 0x00, 0x00, 0x40, 0x80, 0x02, 0x00, 0x00, 0x5f, 0x05, 0x00,	// SID1 Voice2
  0x00, 0x14, 0x00, 0xf0, 0x00, 0x08, 0x00, 0x00, 0x40, 0x80, 0x02, 0x00, 0x00, 0x5f, 0x05, 0x00,	// SID1 Voice3
  0x00, 0x04, 0x00, 0xf0, 0x00, 0x08, 0x00, 0x00, 0x40, 0x80, 0x02, 0x00, 0x00, 0x5f, 0x05, 0x00,	// SID2 Voice1
  0x00, 0x14, 0x00, 0xf0, 0x00, 0x08, 0x00, 0x00, 0x40, 0x80, 0x02, 0x00, 0x00, 0x5f, 0x05, 0x00,	// SID2 Voice2
  0x00, 0x14, 0x00, 0xf0, 0x00, 0x08, 0x00, 0x00, 0x40, 0x80, 0x02, 0x00, 0x00, 0x5f, 0x05, 0x00,	// SID2 Voice3
...
//Speed Asgn  Begin End   Loop    Speed Asgn  Begin End   Loop
  0xcb, 0x00, 0x00, 0x1f, 0x80,   0xcb, 0x00, 0x20, 0x3f, 0xa0,	// WT#1 and WT#2
  0xcb, 0x00, 0x40, 0x5f, 0xc0,   0xcb, 0x00, 0x60, 0x7f, 0xe0,	// WT#3 and WT#4
...
const u8 mbSidPatchPresetBassline[512] = {
...
//PAR1  PAR2  INIT  MIN   MAX     PAR1  PAR2  INIT  MIN   MAX
  0x61, 0x00, 0x08, 0x00, 0xff,   0x65, 0x00, 0xff, 0x00, 0xff,	// Knob1/2
  0x69, 0x00, 0x60, 0x00, 0xff,   0x6d, 0x00, 0x30, 0x00, 0xff,	// Knob3/4
  0x71, 0x00, 0x20, 0x00, 0xff,   0x00, 0x00, 0x80, 0x00, 0xff,	// Knob5/Vel
  0x51, 0x00, 0x80, 0x00, 0xff,   0x00, 0x00, 0x80, 0x00, 0xff,	// PB/Aftertouch
...
//C/M    CutOff      Res.  -     -
  0x17,  0x08, 0x00, 0xf0, 0x00, 0x00,	// Filter1
  0x17,  0x08, 0x00, 0xf0, 0x00, 0x00,	// Filter2


// Voice #1
//Flgs  Wave   AD    SR   PW_L  PW_H  Acc   Delay Trns  Fine  PRng  Port. ArpM  A.S/D A.G/R Res2
  0x01, 0x04, 0x00, 0xc0, 0x00, 0x09, 0x10, 0x00, 0x28, 0x80, 0x02, 0x28, 0x00, 0x5f, 0x05, 0x00,
...
// Voice #2
//Flgs  Wave   AD    SR   PW_L  PW_H  Acc   Delay Trns  Fine  PRng  Port. ArpM  A.S/D A.G/R Res2
  0x01, 0x02, 0x00, 0xc0, 0x00, 0x09, 0x10, 0x00, 0x28, 0x80, 0x02, 0x28, 0x00, 0x5f, 0x05, 0x00,
//Flgs2 ----  ----  ----  L1Md  L1DP  L1Rt  L1Dl  L1Ph  L1DPW L1DF  L2Md  L2DP  L2Rt  L2Dl  L2Ph
  0x07, 0x00, 0x00, 0x00, 0x03, 0x80, 0x06, 0x00, 0x00, 0x80, 0x80, 0x03, 0x80, 0x16, 0x00, 0x00,
//L2DPW L2DF  EMod  EDPi  EDPW  EDFl  EAtt  EDec  ESus  ERel  ECur  SSpd  SNum  Len.  Asgn  res
...
// Sequencer
  0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,	// Notes Sequence #1
  0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,	// Notes Sequence #2
  0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,	// Notes Sequence #3
  0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,	// Notes Sequence #4
  0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,	// Notes Sequence #5
  0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,	// Notes Sequence #6
  0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,	// Notes Sequence #7
  0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,	// Notes Sequence #8

  0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,	// Par Sequence #1
  0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,	// Par Sequence #2
  0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,	// Par Sequence #3
  0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,	// Par Sequence #4
  0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,	// Par Sequence #5
  0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,	// Par Sequence #6
  0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,	// Par Sequence #7
  0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40,	// Par Sequence #8
};


const u8 mbSidPatchPresetDrum[512] = {
  'D','r','u','m',' ','K','i','t',' ',' ',' ',' ',' ',' ',' ',' ',
...
//PAR1  PAR2  INIT  MIN   MAX     PAR1  PAR2  INIT  MIN   MAX
  ...
  0x00, 0x00, 0x80, 0x00, 0xff,   0x00, 0x00, 0x80, 0x00, 0xff,	// Knob3/4
  0x00, 0x00, 0x80, 0x00, 0xff,   0x00, 0x00, 0x80, 0x00, 0xff,	// Knob5/Vel
  0x00, 0x00, 0x80, 0x00, 0xff,   0x00, 0x00, 0x80, 0x00, 0xff,	// PB/Aftertouch
...
//Flgs  Model  AD    SR   Tune  PAR1  PAR2  PAR3  VelA  res.
  0x00, 0x00, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #1
  0x00, 0x01, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #2
  0x00, 0x02, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #3
  0x00, 0x03, 0x09, 0xc9, 0xff, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #4
  0x00, 0x04, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #5
  0x00, 0x05, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #6
  0x00, 0x06, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #7
  0x00, 0x07, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #8
  0x00, 0x08, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #9
  0x00, 0x09, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #10
  0x00, 0x0a, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #11
  0x00, 0x0b, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #12
  0x00, 0x0c, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #13
  0x00, 0x0d, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #14
  0x00, 0x0e, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #15
  0x00, 0x0f, 0x09, 0xc9, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00,	// Instrument #16


// Sequencer tracks
// Trk1                  Trk2                  Trk3                  Trk4
// gate acc.  gate acc.  gate acc.  gate acc.  gate acc.  gate acc.  gate acc.  gate acc.
  0x11,0x00, 0x11,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#1, Trk1-4
// Trk5                  Trk6                  Trk7                  Trk8
  0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#1, Trk5-8

  0x11,0x00, 0x11,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#2, Trk1-4
  0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#2, Trk5-8

  0x11,0x00, 0x11,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#3, Trk1-4
  0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#3, Trk5-8

  0x11,0x00, 0x11,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#4, Trk1-4
  0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#4, Trk5-8
  
  0x11,0x00, 0x11,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#5, Trk1-4
  0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#5, Trk5-8
  
  0x11,0x00, 0x11,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#6, Trk1-4
  0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#6, Trk5-8
  
  0x11,0x00, 0x11,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#7, Trk1-4
  0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#7, Trk5-8
  
  0x11,0x00, 0x11,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#8, Trk1-4
  0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,	// SEQ#8, Trk5-8
};


const u8 mbSidPatchPresetMulti[512] = {
  'M','u','l','t','i',' ','P','a','t','c','h',' ',' ',' ',' ',' ',
...
// Instrument #1
//Flgs  Wave   AD    SR   PW_L  PW_H  Res1  Delay Trns  Fine  PRng  Port. ArpM  A.S/D A.G/R Res2
  0x00, 0x04, 0x00, 0xfa, 0x00, 0x08, 0x00, 0x00, 0x40, 0x80, 0x02, 0x00, 0x00, 0x5f, 0x05, 0x00,
